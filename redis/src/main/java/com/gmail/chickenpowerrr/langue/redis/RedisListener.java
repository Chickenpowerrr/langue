    ...
    public void onMessage(String channel, String message) {
        ...
        switch(totalObject.get("type").getAsString().toLowerCase()) {
            ...
            case "delete_languages":
                this.updater.deleteLanguages(this.gson.fromJson(totalObject.get("value"), this.collectionType));
                break;
            case "delete_translations":
                this.updater.deleteTranslations(this.gson.fromJson(totalObject.get("value"), this.collectionType));
                break;
            default:
                break;
        }
