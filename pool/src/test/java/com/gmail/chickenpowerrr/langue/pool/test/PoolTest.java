...
public class PoolTest {
    ...
    private LanguageResource getLanguageResourcePool() {
        return this.languageResourceFactory.getLanguageResource("Pool", new LanguageResourceCredentials()
                .addProperty("parts", new HashMap<String, LanguageResource>() {{
            put("yml1", languageResourceFactory.getLanguageResource("Yaml", new LanguageResourceCredentials()
                    .addProperty("fileLocation", new File("resources").getAbsolutePath()
                            .replace("resources", "src/main/resources/test.yml"))));
            put("yml2", languageResourceFactory.getLanguageResource("Yaml", new LanguageResourceCredentials()
                    .addProperty("fileLocation", new File("resources").getAbsolutePath()
                            .replace("resources", "src/main/resources/test2.yml"))));
            put("json",languageResourceFactory.getLanguageResource("JSON", new LanguageResourceCredentials()
                    .addProperty("fileLocation", new File("resources").getAbsolutePath()
